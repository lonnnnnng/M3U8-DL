...
- 更新检查、日志文件、ANSI 进度条。
- HTTP：默认 User-Agent、自定义 Header、系统代理、自定义代理、超时、重试、gzip/deflate/br 响应解压。
